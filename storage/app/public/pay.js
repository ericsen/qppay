...
$(document).ready(function(){
    ...
    $("#bankNoMatchBtn, #bankMatchBtn").click(function(){
        ...
        startLoading();
        RaySys.AJAX.Send({ id : id, bank : mainObject.bank, match : $(this).data("match") }, "/ajax/bankCheck", "bankCheckSu", "bankCheckEr");
    });
...
function bankCheckSu(_data){
    if(_data.ResultJSON != undefined){
        ...
        $("#copyPoints").attr("data-clipboard-text", _data.realPoints);
